...
import { Badge } from '@fastbase/ui/components/badge'
import { Card, CardContent, CardHeader, CardTitle } from '@fastbase/ui/components/card'
              ...
              <div className="grid grid-cols-1 gap-4 mt-2">
                {filteredEnums.map(enumItem => (
                  <Card
                    ...
                    className="overflow-hidden border border/60 hover:border/90 transition-colors"
                  >
